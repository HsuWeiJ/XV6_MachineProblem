...
void f5(void *arg)
{
  ...
  16:	e2e50513          	addi	a0,a0,-466 # e40 <thread_start_threading+0x62>
  1a:	00001097          	auipc	ra,0x1
  1e:	856080e7          	jalr	-1962(ra) # 870 <printf>
  22:	44ad                	li	s1,11
  24:	00001a17          	auipc	s4,0x1
  28:	e1ca0a13          	addi	s4,s4,-484 # e40 <thread_start_threading+0x62>
        if (i == 17) {
  2c:	49c5                	li	s3,17
  ...
  36:	c68080e7          	jalr	-920(ra) # c9a <thread_yield>
        printf("thread 5: %d\n", i++);
  ...
  52:	cb8080e7          	jalr	-840(ra) # d06 <thread_exit>
...
void f4(void *arg)
{
  ...
  70:	de450513          	addi	a0,a0,-540 # e50 <thread_start_threading+0x72>
  74:	00000097          	auipc	ra,0x0
  78:	7fc080e7          	jalr	2044(ra) # 870 <printf>
  7c:	3e900493          	li	s1,1001
  80:	00001a17          	auipc	s4,0x1
  84:	dd0a0a13          	addi	s4,s4,-560 # e50 <thread_start_threading+0x72>
        if (i == 1011) {
  ...
  94:	c0a080e7          	jalr	-1014(ra) # c9a <thread_yield>
        printf("thread 4: %d\n", i++);
  ...
  b0:	c5a080e7          	jalr	-934(ra) # d06 <thread_exit>
...
void f2(void *arg)
{
  ...
  cc:	d9850513          	addi	a0,a0,-616 # e60 <thread_start_threading+0x82>
  d0:	00000097          	auipc	ra,0x0
  d4:	7a0080e7          	jalr	1952(ra) # 870 <printf>
  d8:	4485                	li	s1,1
  da:	00001a17          	auipc	s4,0x1
  de:	d86a0a13          	addi	s4,s4,-634 # e60 <thread_start_threading+0x82>
        if (i == 9) {
  e2:	49a5                	li	s3,9
  ...
  ec:	bb2080e7          	jalr	-1102(ra) # c9a <thread_yield>
        printf("thread 2: %d\n", i++);
 ...
 108:	c02080e7          	jalr	-1022(ra) # d06 <thread_exit>
...
000000000000010e <f3>:
{
 ...
 14e:	9a2080e7          	jalr	-1630(ra) # aec <thread_add_runqueue>
        printf("thread 3: %d\n", i++);
 152:	6489                	lui	s1,0x2
 154:	71048593          	addi	a1,s1,1808 # 2710 <__global_pointer$+0x104f>
 158:	00001517          	auipc	a0,0x1
 15c:	d1850513          	addi	a0,a0,-744 # e70 <thread_start_threading+0x92>
 160:	00000097          	auipc	ra,0x0
 164:	710080e7          	jalr	1808(ra) # 870 <printf>
 168:	71148493          	addi	s1,s1,1809
 16c:	00001a17          	auipc	s4,0x1
 170:	d04a0a13          	addi	s4,s4,-764 # e70 <thread_start_threading+0x92>
        if (i == 10003) {
 174:	6989                	lui	s3,0x2
 176:	71398993          	addi	s3,s3,1811 # 2713 <__global_pointer$+0x1052>
 17a:	a011                	j	17e <f3+0x70>
        printf("thread 3: %d\n", i++);
 17c:	84ca                	mv	s1,s2
        thread_yield();
 17e:	00001097          	auipc	ra,0x1
 182:	b1c080e7          	jalr	-1252(ra) # c9a <thread_yield>
        printf("thread 3: %d\n", i++);
 ...
 19e:	b6c080e7          	jalr	-1172(ra) # d06 <thread_exit>
...
void f1(void *arg)
{
 ...
 1f0:	c9450513          	addi	a0,a0,-876 # e80 <thread_start_threading+0xa2>
 1f4:	00000097          	auipc	ra,0x0
 1f8:	67c080e7          	jalr	1660(ra) # 870 <printf>
 1fc:	06500493          	li	s1,101
 200:	00001a17          	auipc	s4,0x1
 204:	c80a0a13          	addi	s4,s4,-896 # e80 <thread_start_threading+0xa2>
        if (i == 105) {
 ...
 214:	a8a080e7          	jalr	-1398(ra) # c9a <thread_yield>
        printf("thread 1: %d\n", i++);
 ...
 230:	ada080e7          	jalr	-1318(ra) # d06 <thread_exit>
...
int main(int argc, char **argv)
{
 ...
 242:	c5250513          	addi	a0,a0,-942 # e90 <thread_start_threading+0xb2>
 ...
 26c:	b76080e7          	jalr	-1162(ra) # dde <thread_start_threading>
    printf("\nexited\n");
 270:	00001517          	auipc	a0,0x1
 274:	c2850513          	addi	a0,a0,-984 # e98 <thread_start_threading+0xba>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5e0:	8d450513          	addi	a0,a0,-1836 # eb0 <digits>
 5e4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ac:	808b8b93          	addi	s7,s7,-2040 # eb0 <digits>
 ...
 7ec:	6c090913          	addi	s2,s2,1728 # ea8 <thread_start_threading+0xca>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8b4:	6187b783          	ld	a5,1560(a5) # ec8 <freep>
 ...
 8e2:	00e6ea63          	bltu	a3,a4,8f6 <free+0x50>
{
 ...
 924:	5af73423          	sd	a5,1448(a4) # ec8 <freep>
}
 928:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 956:	57653503          	ld	a0,1398(a0) # ec8 <freep>
 ...
 97e:	54e90913          	addi	s2,s2,1358 # ec8 <freep>
  if(p == (char*)-1)
 982:	5afd                	li	s5,-1
 984:	a88d                	j	9f6 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 986:	00000797          	auipc	a5,0x0
 98a:	55a78793          	addi	a5,a5,1370 # ee0 <base>
 98e:	00000717          	auipc	a4,0x0
 992:	52f73d23          	sd	a5,1338(a4) # ec8 <freep>
 996:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9b8:	50a73a23          	sd	a0,1300(a4) # ec8 <freep>
      return (void*)(p + 1);
...
struct thread *thread_create(void (*f)(void *), void *arg){
 ...
 ac2:	40670713          	addi	a4,a4,1030 # ec4 <id>
 ac6:	431c                	lw	a5,0(a4)
...
void thread_add_runqueue(struct thread *t){
 ...
 af0:	3ec7b783          	ld	a5,1004(a5) # ed8 <current_thread>
 af4:	c38d                	beqz	a5,b16 <thread_add_runqueue+0x2a>
        t->right=NULL;
        t->parent=NULL;
    }
    else{
 ...
 af6:	6fd8                	ld	a4,152(a5)
 af8:	cf15                	beqz	a4,b34 <thread_add_runqueue+0x48>
 afa:	73d8                	ld	a4,160(a5)
 afc:	cf15                	beqz	a4,b38 <thread_add_runqueue+0x4c>
void thread_add_runqueue(struct thread *t){
 ...
 b0a:	da0080e7          	jalr	-608(ra) # 8a6 <free>
            t->right=NULL;
        }
 ...
 b1a:	3ca7b123          	sd	a0,962(a5) # ed8 <current_thread>
        root_thread=t;
 b1e:	00000797          	auipc	a5,0x0
 b22:	3aa7b923          	sd	a0,946(a5) # ed0 <root_thread>
        t->left=NULL;
 b26:	08053c23          	sd	zero,152(a0)
        t->right=NULL;
 b2a:	0a053023          	sd	zero,160(a0)
        t->parent=NULL;
 b2e:	0a053423          	sd	zero,168(a0)
 b32:	8082                	ret
                current_thread->left=t;
 b34:	efc8                	sd	a0,152(a5)
 b36:	a011                	j	b3a <thread_add_runqueue+0x4e>
                current_thread->right=t;
 b38:	f3c8                	sd	a0,160(a5)
            t->parent=current_thread;
 b3a:	f55c                	sd	a5,168(a0)
            t->left=NULL;
 b3c:	08053c23          	sd	zero,152(a0)
            t->right=NULL;
 b40:	0a053023          	sd	zero,160(a0)
 b44:	8082                	ret

0000000000000b46 <dispatch>:
    // TODO
...
void dispatch(void){
 ...
 b52:	38a53503          	ld	a0,906(a0) # ed8 <current_thread>
 b56:	09452783          	lw	a5,148(a0)
 b5a:	e3b1                	bnez	a5,b9e <dispatch+0x58>
    {      
        if(setjmp(current_thread->env)==0)
 b5c:	02050513          	addi	a0,a0,32
 b60:	00000097          	auipc	ra,0x0
 b64:	eb2080e7          	jalr	-334(ra) # a12 <setjmp>
 b68:	ed01                	bnez	a0,b80 <dispatch+0x3a>
        {
            current_thread->env->sp=(unsigned long)current_thread->stack_p;
 b6a:	00000797          	auipc	a5,0x0
 b6e:	36e7b783          	ld	a5,878(a5) # ed8 <current_thread>
 b72:	6f98                	ld	a4,24(a5)
 b74:	e7d8                	sd	a4,136(a5)
            current_thread->env->ra=(unsigned long)current_thread->fp;
 b76:	6398                	ld	a4,0(a5)
 b78:	e3d8                	sd	a4,128(a5)
            current_thread->buf_set=1;
 b7a:	4705                	li	a4,1
 b7c:	08e7aa23          	sw	a4,148(a5)
        }
        longjmp(current_thread->env,1);
 b80:	4585                	li	a1,1
 b82:	00000517          	auipc	a0,0x0
 b86:	35653503          	ld	a0,854(a0) # ed8 <current_thread>
 b8a:	02050513          	addi	a0,a0,32
 b8e:	00000097          	auipc	ra,0x0
 b92:	ebc080e7          	jalr	-324(ra) # a4a <longjmp>
    }
    else
    {
        longjmp(current_thread->env,1);
 ...
 ba8:	ea6080e7          	jalr	-346(ra) # a4a <longjmp>
}
 bac:	b7ed                	j	b96 <dispatch+0x50>

0000000000000bae <schedule>:
void schedule(void){
 ...
 bb8:	32473703          	ld	a4,804(a4) # ed8 <current_thread>
 bbc:	6f5c                	ld	a5,152(a4)
 bbe:	cb81                	beqz	a5,bce <schedule+0x20>
    {
        current_thread = current_thread->left;
 bc0:	00000717          	auipc	a4,0x0
 bc4:	30f73c23          	sd	a5,792(a4) # ed8 <current_thread>
 ...
 bce:	775c                	ld	a5,168(a4)
 bd0:	73d4                	ld	a3,160(a5)
 bd2:	ca81                	beqz	a3,be2 <schedule+0x34>
        if(current_thread != current_thread->parent->right)
 bd4:	02d70663          	beq	a4,a3,c00 <schedule+0x52>
            current_thread = current_thread->parent->right;
 bd8:	00000797          	auipc	a5,0x0
 bdc:	30d7b023          	sd	a3,768(a5) # ed8 <current_thread>
 be0:	b7e5                	j	bc8 <schedule+0x1a>
        while(current_thread->parent->right==NULL && current_thread!=root_thread)
 be2:	00000597          	auipc	a1,0x0
 be6:	2ee5b583          	ld	a1,750(a1) # ed0 <root_thread>
 bea:	4501                	li	a0,0
 bec:	4805                	li	a6,1
 bee:	08e58563          	beq	a1,a4,c78 <schedule+0xca>
 bf2:	77d4                	ld	a3,168(a5)
 bf4:	72d0                	ld	a2,160(a3)
 bf6:	873e                	mv	a4,a5
 bf8:	8542                	mv	a0,a6
 bfa:	e649                	bnez	a2,c84 <schedule+0xd6>
 bfc:	87b6                	mv	a5,a3
 bfe:	bfc5                	j	bee <schedule+0x40>
            current_thread=current_thread->parent;
 c00:	00000717          	auipc	a4,0x0
 c04:	2cf73c23          	sd	a5,728(a4) # ed8 <current_thread>
            while(current_thread == current_thread->parent->right)
 c08:	77d8                	ld	a4,168(a5)
 c0a:	7354                	ld	a3,160(a4)
 c0c:	00d79b63          	bne	a5,a3,c22 <schedule+0x74>
                current_thread=current_thread->parent->left;
 c10:	6f5c                	ld	a5,152(a4)
            while(current_thread == current_thread->parent->right)
 c12:	77d8                	ld	a4,168(a5)
 c14:	7354                	ld	a3,160(a4)
 c16:	fed78de3          	beq	a5,a3,c10 <schedule+0x62>
 c1a:	00000717          	auipc	a4,0x0
 c1e:	2af73f23          	sd	a5,702(a4) # ed8 <current_thread>
            if(current_thread!=root_thread)
 c22:	00000597          	auipc	a1,0x0
 c26:	2ae5b583          	ld	a1,686(a1) # ed0 <root_thread>
 c2a:	f8f58fe3          	beq	a1,a5,bc8 <schedule+0x1a>
                while(current_thread->parent->right==NULL && current_thread!=root_thread)
 c2e:	00000697          	auipc	a3,0x0
 c32:	2aa6b683          	ld	a3,682(a3) # ed8 <current_thread>
 c36:	76dc                	ld	a5,168(a3)
 c38:	73d0                	ld	a2,160(a5)
 c3a:	4501                	li	a0,0
 c3c:	4805                	li	a6,1
 c3e:	ea11                	bnez	a2,c52 <schedule+0xa4>
 c40:	00d58b63          	beq	a1,a3,c56 <schedule+0xa8>
 c44:	77d8                	ld	a4,168(a5)
 c46:	7350                	ld	a2,160(a4)
 c48:	86be                	mv	a3,a5
 c4a:	8542                	mv	a0,a6
 c4c:	ea19                	bnez	a2,c62 <schedule+0xb4>
 c4e:	87ba                	mv	a5,a4
 c50:	bfc5                	j	c40 <schedule+0x92>
 c52:	87b6                	mv	a5,a3
 c54:	a819                	j	c6a <schedule+0xbc>
 c56:	d92d                	beqz	a0,bc8 <schedule+0x1a>
 c58:	00000797          	auipc	a5,0x0
 c5c:	28d7b023          	sd	a3,640(a5) # ed8 <current_thread>
 c60:	b7a5                	j	bc8 <schedule+0x1a>
 c62:	00000717          	auipc	a4,0x0
 c66:	26f73b23          	sd	a5,630(a4) # ed8 <current_thread>
                if(current_thread!=root_thread)
 c6a:	f4f58fe3          	beq	a1,a5,bc8 <schedule+0x1a>
                    current_thread=current_thread->parent->right;
 c6e:	00000797          	auipc	a5,0x0
 c72:	26c7b523          	sd	a2,618(a5) # ed8 <current_thread>
 c76:	bf89                	j	bc8 <schedule+0x1a>
 c78:	d921                	beqz	a0,bc8 <schedule+0x1a>
 c7a:	00000797          	auipc	a5,0x0
 c7e:	24e7bf23          	sd	a4,606(a5) # ed8 <current_thread>
 c82:	b799                	j	bc8 <schedule+0x1a>
 c84:	00000717          	auipc	a4,0x0
 c88:	24f73a23          	sd	a5,596(a4) # ed8 <current_thread>
        if(current_thread!=root_thread)
 c8c:	f2f58ee3          	beq	a1,a5,bc8 <schedule+0x1a>
            current_thread = current_thread->parent->right; 
 c90:	00000797          	auipc	a5,0x0
 c94:	24c7b423          	sd	a2,584(a5) # ed8 <current_thread>
}
 c98:	bf05                	j	bc8 <schedule+0x1a>

0000000000000c9a <thread_yield>:
void thread_yield(void){
 ...
 ca6:	23653503          	ld	a0,566(a0) # ed8 <current_thread>
 caa:	02050513          	addi	a0,a0,32
 cae:	00000097          	auipc	ra,0x0
 cb2:	d64080e7          	jalr	-668(ra) # a12 <setjmp>
    schedule();
 cb6:	00000097          	auipc	ra,0x0
 cba:	ef8080e7          	jalr	-264(ra) # bae <schedule>
    dispatch();
 cbe:	00000097          	auipc	ra,0x0
 cc2:	e88080e7          	jalr	-376(ra) # b46 <dispatch>
}
 cc6:	60a2                	ld	ra,8(sp)
 cc8:	6402                	ld	s0,0(sp)
 cca:	0141                	addi	sp,sp,16
 ccc:	8082                	ret

0000000000000cce <exit_preorder>:
...
struct thread * exit_preorder(struct thread *t)
{
 ...
 cd6:	6d58                	ld	a4,152(a0)
 cd8:	cf11                	beqz	a4,cf4 <exit_preorder+0x26>
    {
        return t;
    }
    else if(t->right!=NULL)
 cda:	715c                	ld	a5,160(a0)
 cdc:	cf99                	beqz	a5,cfa <exit_preorder+0x2c>
    {
        struct thread * cur=t->right;
        while(cur->right!=NULL)
 cde:	853e                	mv	a0,a5
 ce0:	73dc                	ld	a5,160(a5)
 ce2:	fff5                	bnez	a5,cde <exit_preorder+0x10>
            cur=cur->right;
        return (struct thread *)exit_preorder(cur);
 ce4:	00000097          	auipc	ra,0x0
 ce8:	fea080e7          	jalr	-22(ra) # cce <exit_preorder>
 ...
 cf2:	8082                	ret
    if(t->left ==NULL && t->right==NULL)
 cf4:	715c                	ld	a5,160(a0)
 cf6:	f7e5                	bnez	a5,cde <exit_preorder+0x10>
 cf8:	bfd5                	j	cec <exit_preorder+0x1e>
        return (struct thread *)exit_preorder(t->left);
 cfa:	853a                	mv	a0,a4
 cfc:	00000097          	auipc	ra,0x0
 d00:	fd2080e7          	jalr	-46(ra) # cce <exit_preorder>
 d04:	b7e5                	j	cec <exit_preorder+0x1e>

0000000000000d06 <thread_exit>:
void thread_exit(void){
 ...
 d12:	00000497          	auipc	s1,0x0
 d16:	1c64b483          	ld	s1,454(s1) # ed8 <current_thread>
 d1a:	00000917          	auipc	s2,0x0
 d1e:	1b693903          	ld	s2,438(s2) # ed0 <root_thread>
 d22:	07248463          	beq	s1,s2,d8a <thread_exit+0x84>
        struct thread * epr=exit_preorder(current_thread);
 d26:	8526                	mv	a0,s1
 d28:	00000097          	auipc	ra,0x0
 d2c:	fa6080e7          	jalr	-90(ra) # cce <exit_preorder>
        if(epr == epr->parent->left)
 d30:	755c                	ld	a5,168(a0)
 d32:	6fd8                	ld	a4,152(a5)
 d34:	08a70663          	beq	a4,a0,dc0 <thread_exit+0xba>
        else if(epr == epr->parent->right)
 d38:	73d8                	ld	a4,160(a5)
 d3a:	08a70663          	beq	a4,a0,dc6 <thread_exit+0xc0>
        if(cur == root_thread)
 d3e:	09248763          	beq	s1,s2,dcc <thread_exit+0xc6>
            epr->parent=cur->parent;
 d42:	74dc                	ld	a5,168(s1)
 d44:	f55c                	sd	a5,168(a0)
        epr->left=cur->left;
 d46:	6cdc                	ld	a5,152(s1)
 d48:	ed5c                	sd	a5,152(a0)
        epr->right=cur->right;
 d4a:	70dc                	ld	a5,160(s1)
 d4c:	f15c                	sd	a5,160(a0)
        if(cur == cur->parent->left)
 d4e:	74dc                	ld	a5,168(s1)
 d50:	6fd8                	ld	a4,152(a5)
 d52:	08e48263          	beq	s1,a4,dd6 <thread_exit+0xd0>
        else if (cur == cur->parent->right)
 d56:	73d8                	ld	a4,160(a5)
 d58:	08e48163          	beq	s1,a4,dda <thread_exit+0xd4>
        current_thread=epr;
 d5c:	00000797          	auipc	a5,0x0
 d60:	16a7be23          	sd	a0,380(a5) # ed8 <current_thread>
        free(cur);
 d64:	8526                	mv	a0,s1
 d66:	00000097          	auipc	ra,0x0
 d6a:	b40080e7          	jalr	-1216(ra) # 8a6 <free>
        schedule();
 d6e:	00000097          	auipc	ra,0x0
 d72:	e40080e7          	jalr	-448(ra) # bae <schedule>
        dispatch();
 d76:	00000097          	auipc	ra,0x0
 d7a:	dd0080e7          	jalr	-560(ra) # b46 <dispatch>
}
 ...
 d88:	8082                	ret
    if(current_thread == root_thread && current_thread->left == NULL && current_thread->right == NULL){
 d8a:	6cdc                	ld	a5,152(s1)
 d8c:	ffc9                	bnez	a5,d26 <thread_exit+0x20>
 d8e:	70dc                	ld	a5,160(s1)
 d90:	fbd9                	bnez	a5,d26 <thread_exit+0x20>
        free(current_thread);
 d92:	8526                	mv	a0,s1
 d94:	00000097          	auipc	ra,0x0
 d98:	b12080e7          	jalr	-1262(ra) # 8a6 <free>
        current_thread=NULL;
 d9c:	00000797          	auipc	a5,0x0
 da0:	1207be23          	sd	zero,316(a5) # ed8 <current_thread>
        root_thread=NULL;
 da4:	00000797          	auipc	a5,0x0
 da8:	1207b623          	sd	zero,300(a5) # ed0 <root_thread>
        longjmp(env_st,1);
 dac:	4585                	li	a1,1
 dae:	00000517          	auipc	a0,0x0
 db2:	14250513          	addi	a0,a0,322 # ef0 <env_st>
 db6:	00000097          	auipc	ra,0x0
 dba:	c94080e7          	jalr	-876(ra) # a4a <longjmp>
 dbe:	b7c1                	j	d7e <thread_exit+0x78>
            epr->parent->left=NULL;
 dc0:	0807bc23          	sd	zero,152(a5)
 dc4:	bfad                	j	d3e <thread_exit+0x38>
            epr->parent->right=NULL;
 dc6:	0a07b023          	sd	zero,160(a5)
 dca:	bf95                	j	d3e <thread_exit+0x38>
            root_thread = epr;
 dcc:	00000797          	auipc	a5,0x0
 dd0:	10a7b223          	sd	a0,260(a5) # ed0 <root_thread>
 dd4:	bf8d                	j	d46 <thread_exit+0x40>
            cur->parent->left=epr;
 dd6:	efc8                	sd	a0,152(a5)
 dd8:	b751                	j	d5c <thread_exit+0x56>
            cur->parent->right=epr;
 dda:	f3c8                	sd	a0,160(a5)
 ddc:	b741                	j	d5c <thread_exit+0x56>

0000000000000dde <thread_start_threading>:
void thread_start_threading(void){
 ...
 de4:	0800                	addi	s0,sp,16
    // TODO
    setjmp(env_st);
 de6:	00000517          	auipc	a0,0x0
 dea:	10a50513          	addi	a0,a0,266 # ef0 <env_st>
 dee:	00000097          	auipc	ra,0x0
 df2:	c24080e7          	jalr	-988(ra) # a12 <setjmp>
    if(setjmp(current_thread->env)==0)
 df6:	00000517          	auipc	a0,0x0
 dfa:	0e253503          	ld	a0,226(a0) # ed8 <current_thread>
 dfe:	02050513          	addi	a0,a0,32
 e02:	00000097          	auipc	ra,0x0
 e06:	c10080e7          	jalr	-1008(ra) # a12 <setjmp>
 e0a:	ed01                	bnez	a0,e22 <thread_start_threading+0x44>
    {
        current_thread->env->sp=(unsigned long)current_thread->stack_p;
 e0c:	00000797          	auipc	a5,0x0
 e10:	0cc7b783          	ld	a5,204(a5) # ed8 <current_thread>
 e14:	6f98                	ld	a4,24(a5)
 e16:	e7d8                	sd	a4,136(a5)
        current_thread->env->ra=(unsigned long)current_thread->fp;
 e18:	6398                	ld	a4,0(a5)
 e1a:	e3d8                	sd	a4,128(a5)
        current_thread->buf_set=1;
 e1c:	4705                	li	a4,1
 e1e:	08e7aa23          	sw	a4,148(a5)
    }
    longjmp(current_thread->env,1);
 e22:	4585                	li	a1,1
 e24:	00000517          	auipc	a0,0x0
 e28:	0b453503          	ld	a0,180(a0) # ed8 <current_thread>
 e2c:	02050513          	addi	a0,a0,32
 e30:	00000097          	auipc	ra,0x0
 e34:	c1a080e7          	jalr	-998(ra) # a4a <longjmp>
}
 e38:	60a2                	ld	ra,8(sp)
 e3a:	6402                	ld	s0,0(sp)
